const questions = [
  {
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'theo', no: 'market' },
  },
  {
    name: 'theo',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'theocracy' },
    nextquestion: { no: 'distributism' },
  },
  {
    name: 'distributism',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'distributism' },
    nextquestion: { no: 'conditional_land_ownership' },
  },
  {
    name: 'conditional_land_ownership',
    ...
    results: {},
    nextquestion: { conditional: 'scope_of_government2', unconditional: 'scope_of_government1' },
  },
  {
    name: 'scope_of_government1',
    ...
    results: {},
    nextquestion: { yes: 'watchman_state', no: 'tradvals', nostate: 'counter_economics' },
  },
  {
    name: 'watchman_state',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'welfare_needed', no: 'limited_gov_tradvals' },
  },
  {
    name: 'welfare_needed',
    question_en:
    ...
    results: { welfare: 'socbert', noneed: 'bhl' },
    nextquestion: {},
  },
  {
    name: 'limited_gov_tradvals',
    question_en:
    ...
    answers: ['yes', 'no'],
    results: { yes: 'paleobert', no: 'libert' },
    nextquestion: {},
  },
  {
    name: 'tradvals',
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'tradauthstate', no: 'govbasicneeds' },
  },
  {
    name: 'tradauthstate',
    question_en:
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'corp_cap', no: 'strong_safety_net' },
  },
  {
    name: 'corp_cap',
    ...
    results: {},
    nextquestion: { capitalism: 'markreg', corporatism: 'unions_vs_state' },
  },
  {
    name: 'markreg',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'socnat', no: 'nazcap' },
    nextquestion: {},
  },
  {
    name: 'unions_vs_state',
    ...
    results: { unions: 'natsynd' },
    nextquestion: { state: 'clergygov' },
  },
  {
    name: 'clergygov',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'clerfash' },
    nextquestion: { no: 'racesuperior' },
  },
  {
    name: 'racesuperior',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'nazi', no: 'fascism' },
    nextquestion: {},
  },
  {
    name: 'strong_safety_net',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'neocon', no: 'paleocon' },
    nextquestion: {},
  },
  {
    name: 'govbasicneeds',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'lib', no: 'neolib' },
    nextquestion: {},
  },
  {
    name: 'counter_economics',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'leftroth', no: 'ancap' },
    nextquestion: {},
  },
  {
    name: 'scope_of_government2',
    question_en: 'Should the scope of government be limited?',
    question_cs: 'Mělo by vládní pole působnosti být omezeno?',
    answers: ['yes', 'no', 'nostate'],
    results: { yes: 'geolib', nostate: 'angeo' },
    nextquestion: { no: 'landwelfare' },
  },
  {
    name: 'landwelfare',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'socgeo', no: 'georgism' },
    nextquestion: {},
  },
  {
    name: 'market',
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'statesoc', no: 'marx' },
  },
  {
    name: 'statesoc',
    question_en:
    ...
    answers: ['yes', 'no', 'nostate'],
    results: { yes: 'tito', no: 'marksoc' },
    nextquestion: { nostate: 'mutualaid' },
  },
  {
    name: 'mutualaid',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'natan', no: 'mutualism' },
    nextquestion: {},
  },
  {
    name: 'marx',
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'transstate', no: 'techno' },
  },
  {
    name: 'transstate',
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'soc_directstate1', no: 'labvouch' },
  },
  {
    name: 'soc_directstate1',
    question_en:
    ...
    results: {},
    nextquestion: { workers: 'rev_ed', state: 'vanguard' },
  },
  {
    name: 'vanguard',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'castro' },
    nextquestion: { no: 'cultural_revolution' },
  },
  {
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: '3worlds', no: 'socinone' },
  },
  {
    name: '3worlds',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'aboveall1', no: 'posadism' },
  },
  {
    name: 'aboveall1',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: {},
    nextquestion: { yes: 'synd1', no: 'mediabad' },
  },
  {
    name: 'synd1',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'situationist', no: 'councom' },
    nextquestion: {},
  },
  {
    name: 'labvouch',
  ...
  },
  {
    ...
    answers: ['yes', 'no'],
    results: { yes: 'technocracy' },
    nextquestion: { no: 'electsoc' },
  },
  {
    name: 'electsoc',
    question_en:
    ...
    results: { electoralism: 'demsoc' },
    nextquestion: { revolution: 'soc_directstate2' },
  },
  {
    name: 'soc_directstate2',
    question_en:
      'Should the workers directly own the means of production or should the state be in control of them?',
    question_cs: 'Měli by dělníci přímo vlastnit prostředky výroby, nebo by je měl ovládat stát?',
    answers: ['workers', 'state'],
    results: {},
    nextquestion: { workers: 'agriculture_industrial', state: 'esobullshit' },
  },
  {
    name: 'esobullshit',
    question_en:
    ...
    results: { dasein: '4theory' },
    nextquestion: { classnation: 'bankjews' },
  },
  {
    name: 'bankjews',
    question_en:
    ...
    answers: ['yes', 'no'],
    results: { yes: 'strasser' },
    nextquestion: { no: 'aboveall2' },
  },
  {
    name: 'aboveall2',
    question_en: 'Do you think that the nation should be of most importance above all?',
    ...
    answers: ['yes', 'no'],
    results: { yes: 'nazbol', no: 'statesoc' },
    nextquestion: {},
  },
  {
    name: 'agriculture_industrial',
