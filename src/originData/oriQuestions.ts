export default {
  ...
  coop_ancap: {
    ...
    question_zhCN: '你认为一个完全放松管制、没有国家的社会会导致一个由工人合作社主导的市场吗？',
    answers: ['yes', 'no'],
    results: {
      yes: 'leftroth',
      no: 'ancap',
  ...
  soc_directstate1: {
    ...
    question_zhCN: '在这个阶段，生产资料是应该由工人直接拥有，还是应该由国家来控制？',
  ...
  vanguard_ed: {
    ...
    question_zhCN: '相较于成为某种形式的政治领导，这个先锋队的作用应该只是教育吗？',
    answers: ['yes', 'no'],
    results: {
      yes: 'castro',
    },
  ...
  nep: {
    ...
    question_zhCN: '你认为在实现社会主义前，需要经历一段很长的国家资本主义时期吗？',
    answers: ['yes', 'no'],
    results: {
      yes: 'deng',
      no: 'mao',
