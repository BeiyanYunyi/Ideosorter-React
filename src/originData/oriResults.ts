export default {
  ...
  ancom: {
    ...
    desc_zhCN: '无政府共产主义旨在建立一个基于互助经济的无国家、无阶级、无金钱的社会。',
  },
  angeo: {
  ...
  clerfash: {
    ...
    desc_zhCN: '教权法西斯主义是一种将法西斯主义的政治和经济学说与教权主义相结合的意识形态。',
  },
  councom: {
  ...
  deng: {
    ...
    desc_zhCN: '中国特色社会主义声称，在进入完全的社会主义之前，应当经历一段长期的国家资本主义时期',
  },
  distributism: {
  ...
  lwma: {
    ...
    desc_zhCN: '左翼市场无政府主义旨在建立一个基于后资本主义市场经济的无国家社会。',
  },
  mao: {
  ...
  marksoc: {
    ...
    desc_zhCN: '市场社会主义将工人拥有生产资料的社会主义理想与市场经济提供的竞争和资源分配相结合。',
  },
  minarch: {
  ...
  nazbol: {
    ...
    desc_zhCN: '民族布尔什维克是一个结合了法西斯主义和布尔什维克主义的意识形态。',
  },
  nazcap: {
    ...
    desc_zhCN: '国家资本主义是一种经济上的右翼、文化上的传统主义、民族主义和法西斯主义的意识形态。',
  },
  nazi: {
  ...
  socnat: {
    ...
    desc_zhCN: '社会民族主义是一种民族主义分支，以民族自决、人民主权和社会平等为纲领',
  },
  statesoc: {
    ...
    desc_zhCN: '国有制社会主义认为，生产资料应当由国家所有、由国家管理，与自由意志社会主义针锋相对',
  },
  strasser: {
    ...
    desc_zhCN: '斯特拉瑟主义是由斯特拉塞兄弟推广的一种意识形态，它将左翼经济与右翼极端主义相融合。',
  },
  synd: {
  ...
  theocracy: {
    ...
    result_zhCN: '你是神权主义者',
    desc_zhCN: '在这种意识形态中，统治者作为神的代表，对公民强制执行其特定宗教的法律。',
  },
  tito: {
    ...
    result_zhCN: '你是铁托主义者',
    desc_zhCN: '铁托主义试图将列宁主义的先锋队与市场社会主义经济和工人拥有的生产资料相结合。',
  },
  trot: {
